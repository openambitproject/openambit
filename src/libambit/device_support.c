...
static int_known_device_t known_devices[] = {
    { SUUNTO_USB_VENDOR_ID, 0x002d, "", {0x00,0x00,0x00,0x00}, { "Suunto Traverse Alpha", true, &ambit_device_driver_ambit3, 0x0400, {0x02,0x04,0x59,0x00} } },
    { SUUNTO_USB_VENDOR_ID, 0x002c, "Kaka", {0x01,0x01,0x16,0x00}, { "Suunto Ambit3 Vertical", true, &ambit_device_driver_ambit3, 0x0400, {0x02,0x04,0x59,0x00} } },
    { SUUNTO_USB_VENDOR_ID, 0x002b, "Jabiru", {0x02,0x00,0x12,0x00}, { "Suunto Traverse", true, &ambit_device_driver_ambit3, 0x0400, {0x02,0x04,0x59,0x00} } },
