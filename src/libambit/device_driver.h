...
typedef struct ambit_device_driver_s {
    ...
    int (*custom_mode_write)(ambit_object_t *object, ambit_custom_mode_device_settings_t *ambitCustomModes);
    int (*app_data_write)(ambit_object_t *object, ambit_custom_mode_device_settings_t *ambitCustomModes, ambit_app_rules_t* ambit_apps);
